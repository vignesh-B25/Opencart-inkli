...
/* admin1234/view/template/common/header.twig */
class __TwigTemplate_206bdff9e2f057ab3d9d948c05b99705b159901759ec7b5bc4ff3c7cfa9067a5 extends Template
{
        ...
        <ul class=\"nav navbar-nav\">
          <li id=\"nav-notification\" class=\"nav-item dropdown\">
            ...
            if (($context["notifications"] ?? null)) {
                ...
                $_parent = $context['_parent'];
                unset($context['_seq'], $context['_iterated'], $context['_key'], $context['notification'], $context['_parent']);
                $context = array_intersect_key($context, $_parent) + $_parent;
                // line 47
                yield "                <a href=\"";
...
";
    ...
    {
        return "admin1234/view/template/common/header.twig";
    }
...
", "admin1234/view/template/common/header.twig", "/var/www/html/opencart/upload/admin1234/view/template/common/header.twig");
    }
}
