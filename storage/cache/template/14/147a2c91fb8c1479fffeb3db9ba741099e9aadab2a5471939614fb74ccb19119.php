...
/* admin1234/view/template/common/column_left.twig */
class __TwigTemplate_cc9aff87f7ae63a5215813850cedfa7a2422a115d5e70e6af0ce223c4db06727 extends Template
{
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
                                ...
                                unset($context['_seq'], $context['_iterated'], $context['_key'], $context['children_3'], $context['_parent']);
...
\t\t\t\t\t\t\t\t\t\t\t";
                        ...
                        $_parent = $context['_parent'];
                        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['children_2'], $context['_parent']);
                        $context = array_intersect_key($context, $_parent) + $_parent;
                        // line 39
                        yield "\t\t\t\t\t\t\t\t\t</ul>
\t\t\t\t\t\t\t\t";
...
\t\t\t\t\t\t\t";
                ...
                $_parent = $context['_parent'];
                unset($context['_seq'], $context['_iterated'], $context['_key'], $context['children_1'], $context['_parent']);
                $context = array_intersect_key($context, $_parent) + $_parent;
                // line 44
                yield "\t\t\t\t\t</ul>
\t\t\t\t";
...
\t\t\t";
        ...
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['menu'], $context['_parent']);
        $context = array_intersect_key($context, $_parent) + $_parent;
        // line 49
        yield "\t</ul>
\t";
...
";
    ...
    {
        return "admin1234/view/template/common/column_left.twig";
    }
...
", "admin1234/view/template/common/column_left.twig", "/var/www/html/opencart/upload/admin1234/view/template/common/column_left.twig");
    }
}
