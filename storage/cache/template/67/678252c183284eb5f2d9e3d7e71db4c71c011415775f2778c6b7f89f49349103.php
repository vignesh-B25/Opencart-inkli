...
/* admin2504/view/template/design/layout_form.twig */
class __TwigTemplate_de05f5c10067af8f36b4b8b1f32c79772b30d3e147228ea294cb32f5a186fd4b extends Template
{
  ...
  <div class=\"container-fluid\">
    <div class=\"card\">
      ...
      <div class=\"card-body\">
        ...
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['layout_route'], $context['_parent']);
        $context = array_intersect_key($context, $_parent) + $_parent;
        // line 56
        yield "              </tbody>
              <tfoot>
        ...
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['layout_module'], $context['_parent']);
        $context = array_intersect_key($context, $_parent) + $_parent;
        // line 103
        yield "                  </tbody>
                  <tfoot>
...
";
    ...
    {
        return "admin2504/view/template/design/layout_form.twig";
    }
...
//--></script>
{{ footer }}", "admin2504/view/template/design/layout_form.twig", "/var/www/html/opencart/upload/admin2504/view/template/design/layout_form.twig");
    }
}
