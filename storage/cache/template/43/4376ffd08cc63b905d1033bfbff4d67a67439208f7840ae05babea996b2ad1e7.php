...
/* admin2504/view/template/common/dashboard.twig */
class __TwigTemplate_8f58118d5538475a7789eb9ca349c989b5dc9c23300add726e38512867ca2df1 extends Template
{
    ...
    ";
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["dashboard_1"]) {
                ...
                $_parent = $context['_parent'];
                unset($context['_seq'], $context['_iterated'], $context['_key'], $context['dashboard_2'], $context['_parent']);
                $context = array_intersect_key($context, $_parent) + $_parent;
                // line 28
                yield "          <div class=\"";
        ...
        ";
            ...
            $_parent = $context['_parent'];
            unset($context['_seq'], $context['_iterated'], $context['_key'], $context['dashboard_1'], $context['_parent']);
            $context = array_intersect_key($context, $_parent) + $_parent;
            // line 30
            yield "      </div>
    ";
...
";
    ...
    {
        return "admin2504/view/template/common/dashboard.twig";
    }
...
//--></script>
{{ footer }}", "admin2504/view/template/common/dashboard.twig", "/var/www/html/opencart/upload/admin2504/view/template/common/dashboard.twig");
    }
}
